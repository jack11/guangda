...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/guangda/ThinkPHP/Public/Admin/Css/list.css">
	...
	<div id="wrapper">
		...
		<div id="sidebar">
			...
			<ul class="buttons">
				...
				<li furl="<?php echo U('Download/xz_word');?>">
					<a class="btn ico3"><span>下载专区</span>下载专区</a>
					<span class="tooltip"><span>下载专区</span></span>
					<ul class="tab">
						<li><a url="<?php echo U('Download/xz_word');?>" class="liactive">资料下载</a></li>
						<li><a url="<?php echo U('Download/xz_soft');?>">软件下载</a></li>
					</ul>
				</li>
				<li furl="<?php echo U('Communication/txl');?>">
					<a class="btn ico4"><span>通讯录</span>通讯录</a>
					<span class="tooltip"><span>通讯录</span></span>
				</li>
				<li furl="<?php echo U('Cultural/whfc');?>">
