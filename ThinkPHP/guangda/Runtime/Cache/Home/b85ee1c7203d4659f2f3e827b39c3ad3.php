...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/pro/guangda/ThinkPHP/Public/Home/css/cultural_list.css">
	...
	<div id="content">
	    ...
	    <div id="right">
        	...
        	<div class="right_content">
	        	<ul>
	            	<li><a href="cultural_msg.html"><img src="/pro/guangda/ThinkPHP/Public/Home/images/whfc.png"></a>
	            		<div class="cultural_msg">
            				<div class="cultural_title"><a href="<?php echo U("Cultural/content?id=1");?>">青岛未出口鱼片黑名单企业向美</a></div>
            				<p class="cultural_other">
            					<span>2014-10-10</span><br>
            					青岛未出口鱼片黑名单企业向美青岛未出口鱼片黑名单企业向美青岛未出口鱼片黑名单企业向美
            				</p>
	            		</div>
	            	</li>
	            	<li><a href="cultural_msg.html"><img src="/pro/guangda/ThinkPHP/Public/Home/images/whfc.png"></a>
	            		<div class="cultural_msg">
            				<div class="cultural_title"><a href="cultural_msg.html">青岛未出口鱼片黑名单企业向美</a></div>
            				<p class="cultural_other">
            					<span>2014-10-10</span><br>
            					青岛未出口鱼片黑名单企业向美青岛未出口鱼片黑名单企业向美青岛未出口鱼片黑名单企业向美
            				</p>
