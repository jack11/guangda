...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/pro/guangda/ThinkPHP/Public/Home/css/down_list.css">
...
<body>
	...
	<div id="content">
		<div id="left">
	        ...
	        <div class="">
	        	<ul class="msg_list">
					<?php if(is_array($left_nav[1])): foreach($left_nav[1] as $key=>$v): ?><li class="<?php echo ($v["curr"]); ?>"><a href="<?php echo U("DownLoad/index?c=$v[id]");?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
	            </ul> 
	        </div>
	    ...
	    <div id="right">
	    	<div class="right_title">
	    		<ul class="breadcrumbs">
					<?php if(is_array($right_nav)): foreach($right_nav as $key=>$v): ?><li ><span>&gt;</span><a href="<?php echo U("DownLoad/index?c=$v[id]");?>"><?php echo ($v["name"]); ?></a> </li><?php endforeach; endif; ?>
				</ul>
	    	</div>
        	<div class="right_content">
        		<?php if(($error) == ""): ?><ul>
	        	<?php if(is_array($list)): foreach($list as $key=>$v): ?><li><img src="/pro/guangda/ThinkPHP/Public/upload/images/<?php echo ($v["icon"]); ?>">
	            		<div class="data_msg">
	            			<div class="data_content">
	            				<div class="data_name"><a href="<?php echo U("DownLoad/detail?c=$v[category_id]&id=$v[id]");?>"><?php echo ($v["file"]); ?></a></div>
	            				<p class="data_introduce"><?php echo (substr($v["description"],0,300)); ?></p>
	            			</div>
	            			<div class="data_other">
	            				<span><input type="button" value="下载"></span>
	            				<span><?php echo ($v["count"]); ?>次下载</span>
	            				<span><?php echo ($v["size"]); ?>MB</span>
	            			</div>
	            		</div>
	            	</li><?php endforeach; endif; ?>
	            	<li><img src="/pro/guangda/ThinkPHP/Public/Home/images/docx_win.png">
	            		<div class="data_msg">
	            			<div class="data_content">
	            				<div class="data_name"><a href="down_msg.html">青岛未出口鱼片黑名单企业向美</a></div>
	            				<p class="data_introduce">青岛未出口鱼片黑名单企业向美青岛未出口鱼片黑名单企业向美青岛未</p>
	            			</div>
	            			<div class="data_other">
	            				<span><input type="button" value="下载"></span>
	            				<span>39次下载</span>
