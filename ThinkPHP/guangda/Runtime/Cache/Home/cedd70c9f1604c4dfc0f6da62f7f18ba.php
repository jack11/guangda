...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/guangda/ThinkPHP/Public/Home/css/communication.css">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(".right_content tr:odd").css({background: "#F7F7F7"}); // 1, 3 行
			console.info($(".right_content tr:odd td"));
			$(".right_content tr:odd td").mouseover(function() {
...
<body>
	...
	<div id="content">
		<div id="left">
	        ...
	        <div class="">
	        	<ul class="msg_list">
	        		<?php if(is_array($left_nav[1])): foreach($left_nav[1] as $key=>$v): ?><li class="<?php echo ($v["curr"]); ?>"><a href="<?php echo U("Communication/index?c=$v[id]");?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
	            </ul> 
	        </div>
	    ...
	    <div id="right">
	    	<div class="right_title">
	    		<ul class="breadcrumbs">
					<?php if(is_array($right_nav)): foreach($right_nav as $key=>$v): ?><li ><span>&gt;</span><a href="<?php echo U("Communication/index?c=$v[id]");?>"><?php echo ($v["name"]); ?></a> </li><?php endforeach; endif; ?>
				</ul>
	    	</div>
        	<div class="right_content">
	        	<table>
	        		<thead><th>姓名</th><th>岗位</th><th>座机</th><th>电话</th><th>所属部门</th></thead>
	        		<tr><td>张三</td><td>业务主办</td><td>0759-2533283</td><td>18402060706</td><td>办公室</td></tr>
	        		<tr><td>张三</td><td>业务主办</td><td>0759-2533283</td><td>18402060706</td><td>办公室</td></tr>
	        		<tr><td>张三</td><td>业务主办</td><td>0759-2533283</td><td>18402060706</td><td>办公室</td></tr>
	        		<tr><td>张三</td><td>业务主办</td><td>0759-2533283</td><td>18402060706</td><td>办公室</td></tr>
	        	</table>
